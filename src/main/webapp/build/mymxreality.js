!function (e, t) {
    ...
    var o = {
        ...
        toolBar: function (e) {
            ...
            n.appendChild(r);
            var a = this.createTag("div", {style: "position:inherit;color:#fff;font-size:0.55rem;display:flex;align-items:center;","class": i + "Play"}),
            ...
            n.appendChild(g);
            var E = this.createTag("div", {style: "position:inherit;background:rgba(255,255,255,.3);cursor:pointer","class": "vrSlider"}),
                y = this.createTag("div", {style: "position:inherit;width:0%;height:.0.5rem;background:rgba(255,255,255,.3)"});
            E.appendChild(y);
            var T = this.createTag("div", {style: "position:inherit;width:0%;height:0.5rem;background:rgba(130, 130, 130,.6)"});
